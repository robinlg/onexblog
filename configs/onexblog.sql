...
--
-- Host: 10.37.91.93    Database: onexblog
-- ------------------------------------------------------
...
--
-- Current Database: `onexblog`
--

/*!40000 DROP DATABASE IF EXISTS `onexblog`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `onexblog` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
...
(7,'p','role::user','/v1.OnexBlog/DeleteUser','CALL','deny','',''),
(8,'p','role::user','/v1.OnexBlog/ListUser','CALL','deny','',''),
