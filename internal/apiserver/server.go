...
func (cfg *Config) NewDB() (*gorm.DB, error) {
	...
	casbinRules := []model.CasbinRuleM{
		...
		{PType: ptr.To("p"), V0: &userR, V1: ptr.To("/v1.OnexBlog/DeleteUser"), V2: ptr.To("CALL"), V3: ptr.To("deny")},
		{PType: ptr.To("p"), V0: &userR, V1: ptr.To("/v1.OnexBlog/ListUser"), V2: ptr.To("CALL"), V3: ptr.To("deny")},
