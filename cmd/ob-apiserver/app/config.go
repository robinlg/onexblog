...
const (
	// defaultHomeDir 定义放置 onexblog 服务配置的默认目录.
	defaultHomeDir = ".onexblog"

	// defaultConfigName 指定 onexblog 服务的默认配置文件名.
	defaultConfigName = "ob-apiserver.yaml"
)
