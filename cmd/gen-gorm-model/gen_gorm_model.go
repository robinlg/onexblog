...
var generateConfigs = map[string]GenerateConfig{
	"mb": {ModelPackagePath: "../../internal/apiserver/model", GenerateFunc: GenerateOnexBlogModels},
}
...
var (
	...
	password   = pflag.StringP("password", "p", "root123456", "Password to use when connecting to the database.")
	database   = pflag.StringP("db", "d", "onexblog", "Database name to connect to.")
...
// GenerateOnexBlogModels 为 onexblog 组件生成模型.
func GenerateOnexBlogModels(g *gen.Generator) {
	g.GenerateModelAs(
		"user",
		"UserM",
