...
const file_apiserver_v1_apiserver_proto_rawDesc = "" +
	...
	"\f博客管理\x12\x12列出所有文章*\bListPost\x82\xd3\xe4\x93\x02\v\x12\t/v1/postsB\x80\x02\x92A\xc7\x01\x12\x9d\x01\n" +
	"\fminiblog API\"@\n" +
	"\bOnexBlog\x12#https://github.com/robinlg/onexblog\x1a\x0frobin27@163.com*F\n" +
	"\vMIT License\x127https://github.com/robinlg/onexblog/blob/master/LICENSE2\x031.0*\x01\x022\x10application/json:\x10application/jsonZ3github.com/robinlg/onexblog/pkg/api/apiserver/v1;v1b\x06proto3"
...
var file_apiserver_v1_apiserver_proto_depIdxs = []int32{
	0,  // 0: v1.OnexBlog.Healthz:input_type -> google.protobuf.Empty
	1,  // 1: v1.OnexBlog.Login:input_type -> v1.LoginRequest
	2,  // 2: v1.OnexBlog.RefreshToken:input_type -> v1.RefreshTokenRequest
	3,  // 3: v1.OnexBlog.ChangePassword:input_type -> v1.ChangePasswordRequest
	4,  // 4: v1.OnexBlog.CreateUser:input_type -> v1.CreateUserRequest
	5,  // 5: v1.OnexBlog.UpdateUser:input_type -> v1.UpdateUserRequest
	6,  // 6: v1.OnexBlog.DeleteUser:input_type -> v1.DeleteUserRequest
	7,  // 7: v1.OnexBlog.GetUser:input_type -> v1.GetUserRequest
	8,  // 8: v1.OnexBlog.ListUser:input_type -> v1.ListUserRequest
	9,  // 9: v1.OnexBlog.CreatePost:input_type -> v1.CreatePostRequest
	10, // 10: v1.OnexBlog.UpdatePost:input_type -> v1.UpdatePostRequest
	11, // 11: v1.OnexBlog.DeletePost:input_type -> v1.DeletePostRequest
	12, // 12: v1.OnexBlog.GetPost:input_type -> v1.GetPostRequest
	13, // 13: v1.OnexBlog.ListPost:input_type -> v1.ListPostRequest
	14, // 14: v1.OnexBlog.Healthz:output_type -> v1.HealthzResponse
	15, // 15: v1.OnexBlog.Login:output_type -> v1.LoginResponse
	16, // 16: v1.OnexBlog.RefreshToken:output_type -> v1.RefreshTokenResponse
	17, // 17: v1.OnexBlog.ChangePassword:output_type -> v1.ChangePasswordResponse
	18, // 18: v1.OnexBlog.CreateUser:output_type -> v1.CreateUserResponse
	19, // 19: v1.OnexBlog.UpdateUser:output_type -> v1.UpdateUserResponse
	20, // 20: v1.OnexBlog.DeleteUser:output_type -> v1.DeleteUserResponse
	21, // 21: v1.OnexBlog.GetUser:output_type -> v1.GetUserResponse
	22, // 22: v1.OnexBlog.ListUser:output_type -> v1.ListUserResponse
	23, // 23: v1.OnexBlog.CreatePost:output_type -> v1.CreatePostResponse
	24, // 24: v1.OnexBlog.UpdatePost:output_type -> v1.UpdatePostResponse
	25, // 25: v1.OnexBlog.DeletePost:output_type -> v1.DeletePostResponse
	26, // 26: v1.OnexBlog.GetPost:output_type -> v1.GetPostResponse
	27, // 27: v1.OnexBlog.ListPost:output_type -> v1.ListPostResponse
